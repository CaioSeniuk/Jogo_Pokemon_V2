...
from biblioteca_texto import texto,texto_introducao
from biblioteca_cores import cor
from biblioteca_funcoes import pokemon_porcentagem, pokemon_porcentagem2, introducao, pergunta_fazer, saindo_da_caverna, saindo_do_jogo, saindo_da_floresta, chance_captura_floresta, chance_captura_caverna
...
while True:
    ...
    #Se o usuário capturar todos os pókemons, o jogo encerrará
    if pokedex == ["Bulbasaur", "Golduck", "Charizard","Pikachu", "Golem", "Blastoide"]:
        os.system("cls")
        texto(f"\nParabéns, você capturou todos os Pókemons!\n\nPókedex: {pokedex}\n\n")
        time.sleep(3)
        break
    ...
    if opcao_introducao == 1:
        ...
        while True:
            ...
            #Se 2, entrar na caverna
                ...
                #Se desejar capturar o pókemon, irá acontecer a tentativa
                if escolha_capturar == 1:
                    chance_captura = chance_captura_caverna()
                    if chance_captura == 1:
